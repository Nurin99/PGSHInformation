...
<!-- Main content -->
  ...
  <div class="main">
    <h2 style="text-align: centre;">Contact Directory</h2>
    <!-- Add the following CSS rule to justify-align text -->
    <p style="text-align: justify;">List of Contact Directory</p>
     <!-- Add buttons with symbols -->
    <a class="button" href="consultant.php" class="button">&#128196; Consultant Speed Dial 2023</a>
    <a class="button" href="line.php">&#128196; Speed Dial Staff, Hospital and Insurance 2023</a>
   <!-- Line Directory dropdown -->
   <div class="nav-item right">
    <div class="dropdown" id="line-directory-dropdown">
      <a href="line-directory-level1.php">Level 1</a>
      <a href="line-directory-level2.php">Level 2</a>
      <a href="line-directory-level3.php">Level 3</a>
      <a href="line-directory-level4.php">Level 4</a>
      <a href="line-directory-level5.php">Level 5</a>
      <a href="line-directory-level6.php">Level 6</a>
      <a href="line-directory-level7.php">Level 7</a>
      <a href="line-directory-level8.php">Level 8</a>
    </div>
    <a class="button" href="#" onclick="toggleDropdown('line-directory-dropdown', event)">LINE DIRECTORY ▼</a>
  </div>
  </div>
</div>
</div>
...
<div class="footer">
 ...
 <!-- Navigation link to go to the home page -->
