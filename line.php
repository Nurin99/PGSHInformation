...
if (isset($_POST['searchSubmit'])) {
  ...
  // Perform the search and filter content based on the search value
  // You can implement your specific search logic here. For example, if you want to filter content based on keywords:
  $filteredContent = array();

  // Loop through your content (assuming you have an array of content)
  foreach ($yourContentArray as $contentItem) {
      // Check if the content item contains the search keyword
      if (stripos($contentItem, $searchValue) !== false) {
          // If it does, add it to the filtered content array
          $filteredContent[] = $contentItem;
      }
  }

  // Now you can display the filtered content
...
<div class="main">
<a class="button" href="level1.php" target="_blank">Level 1</a>
<a class="button" href="level2.php" target="_blank">Level 2</a>
<a class="button" href="level3.php" target="_blank">Level 3</a>
<a class="button" href="level4.php" target="_blank">Level 4</a>
<a class="button" href="level5.php" target="_blank">Level 5</a>
<a class="button" href="level6.php" target="_blank">Level 6</a>
<a class="button" href="level7.php" target="_blank">Level 7</a>
<a class="button" href="level8.php" target="_blank">Level 8</a>
</div>
